...
```markdown
![Desktop View](/assets/img/tropical-leaves.jpg){: width="700" height="400" }
```
{: .nolineno}
...
```markdown
![Desktop View](/assets/img/tropical-leaves.jpg){: w="700" h="400" }
```
{: .nolineno}
...
- **Normal position**
  ...
  ```markdown
  ![Desktop View](/assets/img/tropical-leaves.jpg){: .normal }
  ```
  {: .nolineno}
...
- **Float to the left**
  ...
  ```markdown
  ![Desktop View](/assets/img/tropical-leaves.jpg){: .left }
  ```
  {: .nolineno}
...
- **Float to the right**
  ...
  ```markdown
  ![Desktop View](/assets/img/tropical-leaves.jpg){: .right }
  ```
  {: .nolineno}
...
```markdown
![Light mode only](/assets/img/tropical-leaves.jpg){: .light }
![Dark mode only](/assets/img/tropical-leaves.jpg){: .dark }
```
...
```markdown
![Desktop View](/assets/img/tropical-leaves.jpg){: .shadow }
```
{: .nolineno}
